...
ideas into innovation."<b></i></pre></div>
        <div class="edge">
            ...
            <form>
                <table cellpadding="15px" cellspacing="15px">
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="submit" value="LOGIN" style="background-color: greenyellow; color:orangered;">
                        </td>
                    </tr>
                </table>
    ...
    <div class="bottomdiv">
        <p>Designed and Developed by Marella Hasini</p>
    </div>
</body>
<html>
person.html
...
<body background="./webcover3.png">
    <div class="header">
        ...
        <table class="person">
            <tr>
                <td>
                    <img src="./image.png" class="MyPic">
                </td>
                <td>
                    <img src="./Anubharathi.png" class="Anubarathi">
                </td>
                <td>
                    <img src="./Dharanesh.png" class="Dharanesh">
                </td>
                <td>
                    <img src="./varsha.png" class="Varsha">
                </td>
                <td>
                    <img src="./sandhya.png" class="Sandhya">
                </td>
                <td>
                    <img src="./adithyan varma.png" class="adithyan varma">
                </td>
            </tr>
            <tr>
                <td>
...
```
## OUTPUT:
![OUTPUT](homei.html.png)
![OUTPUT](person.html.png)
![OUTPUT](product.html.png)
![Alt text](<contcat us.png>)
